...
def FetchJudgeName(file_text):
    ...
    # Retrieve the first 1024 words
    first_2048_words = ' '.join(words[:2048])
    ...
    texts = custom_text_splitter.create_documents([first_2048_words])
...
def ClaimantPosition(FileText):
    ...
    if lengthsummary > 2048:
        ...
        try:
            ...
            print("Ending ClaimantPosition function t5")    
...
def IssuesConsidered(FileText):
    print("Starting IssuesConsidered function")
    result = []
    #using roberta Q&A model
    model_name = "deepset/roberta-base-squad2"
    model = AutoModelForQuestionAnswering.from_pretrained(model_name)
    ...
    questions = {
        "Issues considered by the Judge : ": "What are Issues considered by the Judge?",
    ...
    print("Ending IssuesConsidered function")
    return result

def Outcome(FileText):
    print("Outcome Function started : ")
    ...
    if match:
        ...
        print("Not Found")
        print("Starting Roberta function")
        result = []
        #using roberta Q&A model
        model_name = "deepset/roberta-base-squad2"
        model = AutoModelForQuestionAnswering.from_pretrained(model_name)
    ...
    inputs = tokenizer.encode(result_text, return_tensors='pt', max_length=1024, truncation=True)
...
def main():
    directory = r"C:\Users\DELL\OneDrive\Desktop\CostsBarrister"
    output_directory = r"C:\Users\DELL\OneDrive\Desktop\CostsBarrister\SummaryCostBarrister"
